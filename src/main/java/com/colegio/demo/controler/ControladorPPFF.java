...
public class ControladorPPFF {
	...
	public ResponseEntity<byte[]> exportPdfID(@PathVariable("id") int id_ppff) throws JRException, FileNotFoundException {
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_PDF);
		headers.setContentDispositionFormData("personalReport", "personalReport_" + id_ppff + ".pdf");

		// Llama al servicio pasando el ID
		byte[] pdfReport = serviceI.exportPdfID(id_ppff);
